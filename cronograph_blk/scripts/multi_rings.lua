...
local gauge = {
	{
		...
		graph_bg_colour=0x909090, graph_bg_alpha=0.0,
		graph_fg_colour=0x0099FF, graph_fg_alpha=0.6,
	...
	},
	{
		...
		graph_unit_angle=3.5, graph_unit_thickness=3.0,
		graph_bg_colour=0x909090, graph_bg_alpha=0.0,
		graph_fg_colour=0xFF0606, graph_fg_alpha=0.6,
		hand_fg_colour=0x830000, hand_fg_alpha=0.7,
		txt_radius=1,
		txt_weight=0, txt_size=8.0,
		txt_fg_colour=0xFFFFFF, txt_fg_alpha=0.0,
	...
	},
	{
		...
		graph_unit_angle=3.5, graph_unit_thickness=3.0,
		graph_bg_colour=0x909090, graph_bg_alpha=0.0,
		graph_fg_colour=0x06FF06, graph_fg_alpha=0.6,
		hand_fg_colour=0x830000, hand_fg_alpha=0.7,
		txt_radius=1,
		txt_weight=0, txt_size=8.0,
		txt_fg_colour=0xFFFFFF, txt_fg_alpha=0.0,
